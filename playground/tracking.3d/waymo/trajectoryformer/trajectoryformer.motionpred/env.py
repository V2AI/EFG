    ...
    def __getitem__(self, idx):
        ...
        for i in range(1,nfuture+1):
            ...
            try:
                ...
                ordered_fut_gt_boxes = self.transform_prebox_to_current_vel(ordered_fut_gt_boxes,
        ...
        info['annotations']["future_gt_boxes"] = fut_gt_boxes.astype(np.float32).reshape(-1,fut_gt_boxes.shape[-1])
