...
from efg.data.structures.boxes import Boxes
...
class FCOS(nn.Module):
    ...
    def losses(
        ...
        """
        pred_class_logits, pred_shift_deltas, pred_centerness = permute_all_cls_and_box_to_N_HWA_K_and_concat(
            pred_class_logits, pred_shift_deltas, pred_centerness, self.num_classes
