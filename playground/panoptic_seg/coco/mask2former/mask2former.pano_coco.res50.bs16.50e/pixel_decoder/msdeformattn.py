...
from efg.modeling.operators.ms_deform_attn import MSDeformAttn
...
class MSDeformAttnPixelDecoder(nn.Module):
    def __init__(self, config, input_shape: Dict[str, ShapeSpec]):
        ...
        # ret["transformer_dim_feedforward"] = config.MODEL.MASK_FORMER.DIM_FEEDFORWARD
        transformer_dim_feedforward = 1024  # use 1024 for deformable transformer encoder
        transformer_enc_layers = config.MODEL.SEM_SEG_HEAD.TRANSFORMER_ENC_LAYERS  # a separate config
