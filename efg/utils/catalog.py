...
from .file_io import PathHandler, PathManager
...
class ModelCatalog(object):
    ...
    S3_D2_DETECTRON_PREFIX = "https://dl.fbaipublicfiles.com/detectron"
    ...
    def _get_c2_detectron_baseline(name):
        ...
        if "keypoint_rcnn" in name:
            ...
            dataset = ModelCatalog.D2_DATASET_COCO
        ...
        # Detectron D2 models are stored in the structure defined in `D2_DETECTRON_PATH_FORMAT`.
        url = ModelCatalog.D2_DETECTRON_PATH_FORMAT.format(
            prefix=ModelCatalog.S3_D2_DETECTRON_PREFIX, url=url, type=type, dataset=dataset
        )
        return url
